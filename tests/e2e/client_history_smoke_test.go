...
import (
	...
	managerworkspace "github.com/pershin-daniil/ninja-chat-bank/tests/e2e/manager-workspace"
	wsstream "github.com/pershin-daniil/ninja-chat-bank/tests/e2e/ws-stream"
)
